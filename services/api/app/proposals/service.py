...
async def generate_proposal(
    ...
    if country is None:
        ...
        proposal = Proposal(
            case_id=case_id,
            country_name=country.get("country", jurisdiction),
            country_code=country.get("country_code"),
            nice_classes=nice_classes,
            required_documents=country.get("required_documents"),
            registration_period=country.get("registration_period"),
            protection_period=country.get("protection_period"),
            madrid_system=country.get("madrid"),
            national_application=country.get("national"),
            opposition_period=country.get("opposition_period"),
            special_notes=country.get("special_notes"),
            price=None,
            currency=None,
            status=ProposalStatus.draft,
            created_by=created_by,
